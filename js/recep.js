(function () {
  ...
  // ─────────────────────────────────────────────────────────────
  // RECEPTIVE COMMUNICATION — subskills & drills
  // ─────────────────────────────────────────────────────────────
  const TIERS = [
  ...
  const DRILL_OPTIONS = {
    'Eye Contact':            ['Name Call', 'Hello', 'Tap'],
    'Basic Understanding':    ['Come Here', 'Sit Down', 'Stand Up'],
    'Identification':         ['Pointing to Facial Expression', 'Pointing to Body Parts'],
